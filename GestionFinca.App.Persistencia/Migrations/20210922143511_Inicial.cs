        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantidadIngreso = table.Column<float>(type: "real", nullable: false),
                    CantidadSalida = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FestilizantesEnmiendas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventarios_FestilizantesEnmiendas_fertilizanteEnmiendaId",
                        column: x => x.fertilizanteEnmiendaId,
                        principalTable: "FestilizantesEnmiendas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantProdSembrados = table.Column<int>(type: "int", nullable: false),
